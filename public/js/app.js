...
vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default().use(vue_axios__WEBPACK_IMPORTED_MODULE_2__["default"], (axios__WEBPACK_IMPORTED_MODULE_1___default()));
axios__WEBPACK_IMPORTED_MODULE_1___default().interceptors.response.use(function (response) {
  return response;
}, function (error) {
  vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default().swal({
    type: 'error',
    icon: 'error',
    title: 'Error',
